...
class Sweets extends Candies
{
	...
	public void identify(String a)
	{
		...
		else
		{
			sweet_wt=60;
			/*g.sweetWeight(w1);
			s1.candyWeight(totalCandyWeight);
			s1.display();*/
		}
	}
}
...
class Gift extends Sweets
{
	...
	static int i=1;
	float totalWeight,c;
	/*public void sweetWeight(float a)
{
c=a;
}
public void candyWeight(int b)
{
d=b;
}*/
...
/*class A extends Sweets
{
A ob=new A();
if(b=="Khaju")
{
ob.sweetWeight(w1);
ob.candyWeight(totalCandyWeight);
ob.display();
}
else
{
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println((i+1)+" gift opened and the items in it are:--");
